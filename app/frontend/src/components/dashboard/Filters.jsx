...
export default function Filters({ cities, selectedCity, onCityChange, selectedScore, onScoreChange, thresholds = { good: 80, average: 50 } }) {
  return (
      ...
      <div className="flex flex-1 sm:justify-end gap-4 w-full sm:w-auto">
        ...
        <div className="relative w-full sm:w-52">
          ...
          >
            ...
            <option value="good">Fort potentiel (≥{thresholds.good})</option>
            <option value="average">Moyen ({thresholds.average}–{thresholds.good - 1})</option>
            <option value="bad">Faible (&lt;{thresholds.average})</option>
          </select>
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-slate-500">
            <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
          </div>
